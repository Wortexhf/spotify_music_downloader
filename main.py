...
async def handle_spotify(message: Message):
    ...
    if "/track/" in url:
        ...
        await send_track(message, track_info, audio_path, cover_path, status, show_cover=True)
        ...
        for i, track in enumerate(tracks, 1):
            try:
                ...
                await send_track(message, track, audio_path, cover_path, status_msg=None, show_cover=(i == 1))
...
async def send_track(message: Message, track_info: dict, audio_path: str, cover_path: str, status_msg=None, show_cover=True):
